...
@app.on_message(filters.command("كيفية استخدام فوكس","."))
def vgdg(client,message):
        message.reply_text(
            f"""- **هلا والله ياعيني عشان تفعل بوت فوكس اتبع الخطوات الي بالاسفل**
1 • ارفعه مشرف بكل الصلاحيات 
2 • لو تبي تشوف الاوامر اكتب [ الاوامر ] ولو تبي تشغل على طول اكتب تشغيل + اسم المقطع الصوتي
...
[ `تنزيل` + اسم المطلوب ..]
مثال -› تنزيل الما والاه الصوج من امه
